...
(function (ProjectCategory) {
    ProjectCategory[ProjectCategory["PRODUCT_OR_UX_DESIGN"] = 0] = "PRODUCT_OR_UX_DESIGN";
    ProjectCategory[ProjectCategory["SERVICE_DESIGN"] = 1] = "SERVICE_DESIGN";
    ProjectCategory[ProjectCategory["BRANDING_OR_PACKAGING"] = 2] = "BRANDING_OR_PACKAGING";
    ProjectCategory[ProjectCategory["ILLUSTRATIONS"] = 3] = "ILLUSTRATIONS";
    ...
    const caseStudies = [
        {
            ...
            year: '2023',
            tags: [ProjectCategory.PRODUCT_OR_UX_DESIGN],
            preview_image: {
        ...
        },
        {
            ...
            year: '2021',
            tags: [ProjectCategory.SERVICE_DESIGN, ProjectCategory.BRANDING_OR_PACKAGING],
            preview_image: {
                path: './images/dash.png',
        ...
        },
        {
            ...
            year: '2021',
            tags: [ProjectCategory.SERVICE_DESIGN],
            preview_image: {
                path: './images/dash.png',
        ...
        },
        {
            ...
            year: '2021',
            tags: [ProjectCategory.BRANDING_OR_PACKAGING],
            preview_image: {
                path: './images/dash.png',
